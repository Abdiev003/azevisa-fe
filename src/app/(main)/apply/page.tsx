...
export default async function ApplyPage() {
  ...
  const labels = {
    sidebar: {
      ...
      applicantsTitle: t("sidebar.applicantsTitle"),
      currentApplicantBadge: t("sidebar.currentApplicantBadge"),
      steps: {
    ...
    step5: {
      ...
      manageApplicantsSubtitle: t("step5.manageApplicantsSubtitle"),
      ...
      agreementLabel: t("step5.agreementLabel"),
      termsLink: t("step5.termsLink"),
      privacyLink: t("step5.privacyLink"),
      addPerson: t("step5.addPerson"),
      addPersonHint: t("step5.addPersonHint"),
      back: t("step5.back"),
      next: t("step5.next"),
    },
    step6: {
      ...
      processingTimeLabel: t("step6.processingTimeLabel"),
      validityLabel: t("step6.validityLabel"),
      maxStayLabel: t("step6.maxStayLabel"),
      paymentMethodTitle: t("step6.paymentMethodTitle"),
      paymentMethodSubtitle: t("step6.paymentMethodSubtitle"),
      secureCheckoutBadge: t("step6.secureCheckoutBadge"),
      redirectNotice: t("step6.redirectNotice"),
      payWithCard: t("step6.payWithCard"),
      cardFlowHint: t("step6.cardFlowHint"),
      alternativeDivider: t("step6.alternativeDivider"),
      payWithPayPal: t("step6.payWithPayPal"),
      payWithPayPalHint: t("step6.payWithPayPalHint"),
  ...
  return (
    <main className="min-h-screen bg-[#F8F9FA] py-10 px-4">
      <div className="max-w-5xl mx-auto">
        <ApplyWizard
          labels={labels}
          allCountriesOptions={countries.map((c) => ({
            id: c.id,
            name: c.name,
          }))}
