  ...
  return (
    <header className="relative flex items-center justify-between w-full px-6 py-4 bg-white">
      ...
      <div className="items-center hidden gap-6 lg:flex">
        ...
        <Button onClick={() => {}}>{tH("applyNow")}</Button>
      </div>
      ...
      {isMenuOpen && (
        <div className="absolute left-0 right-0 z-50 bg-white border-t border-gray-100 shadow-md top-full lg:hidden">
          <nav className="px-6 py-4">
            ...
            {/* Apply Now — only on mobile (tablet already shows it in header) */}
