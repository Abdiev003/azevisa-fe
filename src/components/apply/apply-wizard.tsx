...
function uniqueApplicantsByReference(applicants: ApplicantDraft[]) {
  ...
  }[] = [
    {
      ...
      icon: (
        <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="4" y="8" width="40" height="32" rx="10" fill="#635BFF" />
          <path
            d="M15 20.5C15 18.567 16.567 17 18.5 17H29.5C31.433 17 33 18.567 33 20.5V21H15V20.5Z"
            fill="white"
            fillOpacity="0.9"
          />
          <rect x="15" y="24" width="18" height="3" rx="1.5" fill="white" />
          <rect
            x="15"
            y="29"
            width="10"
  ...
  const handlePaymentSelection = useCallback(
    async (paymentMethod: PaymentMethod) => {
      ...
      try {
        ...
        const allApplicants: ApplicantDraft[] = uniqueApplicantsByReference((() => {
          if (!activeApplicantId) {
            return applicants;
          }
